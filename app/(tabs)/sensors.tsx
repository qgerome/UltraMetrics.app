import { StyleSheet, Image, Platform, View, Button, ScrollView, Text, ActivityIndicator } from 'react-native';
...
const DeviceRow =  ({device}: {device: Device}) => {
  ...
  return (
    <ThemedView style={styles.device}>
      ...
      {!isLoading && isConnected && <IconSymbol name="checkmark" color="green"/>}
...
export default function TabSensorsScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        {devices.length === 0 && isScanning && <ThemedText style={styles.device}>Scanning...</ThemedText>}
        {devices.map(device => (
